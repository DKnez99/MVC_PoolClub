#pragma checksum "E:\Programming\Random Stuff\PoolClub\Views\Reservations\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "386be875f7ab82873ab7c3276bd5feac0c9b63d3"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"386be875f7ab82873ab7c3276bd5feac0c9b63d3", @"/Views/Reservations/Index.cshtml")]
...
#nullable disable
            WriteLiteral("    </tbody>\r\n</table>\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "386be875f7ab82873ab7c3276bd5feac0c9b63d39710", async() => {
            }
            );
...
<script type=""text/javascript"">
    ...
    connection.on(""ReceiveReservation"", (reservation) => {
        ...
        newRow.onclick = function (row) {
            return function () {
                callback(row);
            };
        }(newRow);
        //newRow.onclick = ""window.location = '/Reservations/Details/"" + reservation[0] + ""'"";
        //newRow.onclick = ""window.location = '/Home/Index'"";
    ...
    connection.on(""DeleteReservation"", (reservationId) => {
        ...
        for (var i = rows.length; i--;) {
            if (rows[i].cells[0].innerHTML==reservationId) {
                rows[i].par");
            WriteLiteral(@"entNode.removeChild(rows[i]);
            }
        }
    });
    ...
    onRowClick(""reservationsTable"", function (row) {
        ...
        window.location = ""/R");
            WriteLiteral("eservations/Details/\" + value;\r\n    });\r\n</script>");
        }
